        ...
        <section className="productsSection">
          <div className="productDiv">
            ...
            <p className="productText">
              Kombucha is a naturally fermented soda style drink made using tea
              as a main, filled with beneficial bacteria, supporting gut health,
              giving you a range of natural probiotics..
            </p>
          ...
          <div className="productDiv">
            ...
            <p className="productText">
              Our naturally fermented raw vinegar is made using a base of
              freshly juiced apples, which we ferment into cider, and in turn
              into vinegar. Rosehips are foraged locally in season, adding
              medicinal benefits along with a delicate fruity flavour.
            </p>
            <div className="whiteSegment">
              <button className="curiousButton">Curious?</button>
              <button className="addButton">Add to Basket</button>
          ...
          <div className="productDiv">
            ...
            <p className="productText">
              Our innovative probiotic juice is made with health and wellbeing
              in mind. Taken daily our probiotic juice is the ideal way to get
              an adequate dose of natural probiotics into your system.
            </p>
            <div className="whiteSegment">
              <button className="curiousButton">Curious?</button>
              <button className="addButton">Add to Basket</button>
        ...
        <div className="aboutRoseAndMargaux">
          ...
          <div>
            ...
            <p>
              ...
              <br />
              <br />
              She has always focused her career on produce, going to the source
              and supporting farmers while instilling the importance of
              providence to young budding cooks she mentored throughout her 15
        ...
        <div className="aboutRoseAndMargaux">
          <div>
            ...
            <p>
              ...
              natural surroundings. Within Europe she gained an extensive
              knowledge in organic farming practices, working along side some
              amazing farming minds to develop her own growing style which she
              uses today. Wellbeing is also key to life, as she continually
              strives to increase her knowledge in medicinal plants and their
              uses. Together Rose and Margaux call upon their experience daily
              to help them achieve their goals as a leading sustainable food
              business.
            </p>
          </div>
